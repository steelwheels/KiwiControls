...
public class UTVelocity {
	...
	public func executeTest() -> Bool {
		...
		mConsole.print(string: "v00 = \(v00.description)\n")
		
		let v01 = KCVelocity(x: 10.0, y:-10.0)
		mConsole.print(string: "v01 = \(v01.description)\n")
		
		let v02 = KCVelocity(x:  0.0, y:10.0)
		mConsole.print(string: "v02 = \(v02.description)\n")
		
		let v03 = KCVelocity(x: 10.0, y: 0.0)
		mConsole.print(string: "v03 = \(v03.description)\n")
		
		let PI = CGFloat(M_PI)
		
		let v10 = KCVelocity(v: 10.0, angle: 0.0 * PI)
		mConsole.print(string: "v10 = \(v10.description)\n")
		
		let v11 = KCVelocity(v: 10.0, angle: 0.25 * PI)
		mConsole.print(string: "v11 = \(v11.description)\n")
		
		let v12 = KCVelocity(v: 10.0, angle: 0.5 * PI)
		mConsole.print(string: "v12 = \(v12.description)\n")
		
		let v13 = KCVelocity(v: 10.0, angle: 1.5 * PI)
		mConsole.print(string: "v13 = \(v13.description)\n")
